...
const times = {
    ...
    const timeStamp = {
      ...
      fifteenDayAgo: `${TimeGoTest.fifteenDayAgoMonth+1}/${TimeGoTest.fifteenDayAgo}`,
      twentyDayAgo: `${TimeGoTest.twentyDayAgoMonth+1}/${TimeGoTest.twentyDayAgo}`,
      twentyFiveDayAgo: `${TimeGoTest.twentyFiveDayAgoMonth+1}/${TimeGoTest.twentyFiveDayAgo}`,
      thirtyDayAgo: `${TimeGoTest.thirtyDayAgoMonth+1}/${TimeGoTest.thirtyDayAgo}`,
