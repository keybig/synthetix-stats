...
export type AccountFlaggedForLiquidationArgs<K extends keyof AccountFlaggedForLiquidationResult> = {
    [Property in keyof Pick<AccountFlaggedForLiquidationFields, K>]: AccountFlaggedForLiquidationFields[Property];
};
export const getAccountFlaggedForLiquidationById = async function <K extends keyof AccountFlaggedForLiquidationResult>(url: string, options: SingleQueryOptions, args: AccountFlaggedForLiquidationArgs<K>): Promise<Pick<AccountFlaggedForLiquidationResult, K>> {
    ...
    if (obj["collateralRatio"])
        formattedObj["collateralRatio"] = wei(obj["collateralRatio"], 0);
    if (obj["liquidatableNonEscrowSNX"])
        formattedObj["liquidatableNonEscrowSNX"] = wei(obj["liquidatableNonEscrowSNX"]);
    if (obj["collateral"])
        formattedObj["collateral"] = wei(obj["collateral"]);
    return formattedObj as Pick<AccountFlaggedForLiquidationResult, K>;
};
export const getAccountFlaggedForLiquidations = async function <K extends keyof AccountFlaggedForLiquidationResult>(url: string, options: MultiQueryOptions<AccountFlaggedForLiquidationFilter, AccountFlaggedForLiquidationResult>, args: AccountFlaggedForLiquidationArgs<K>): Promise<Pick<AccountFlaggedForLiquidationResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<AccountFlaggedForLiquidationFilter, AccountFlaggedForLiquidationResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof AccountFlaggedForLiquidationFilter;
...
export const getAccountLiquidatedById = async function <K extends keyof AccountLiquidatedResult>(url: string, options: SingleQueryOptions, args: AccountLiquidatedArgs<K>): Promise<Pick<AccountLiquidatedResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["account"])
        formattedObj["account"] = obj["account"];
    if (obj["snxRedeemed"])
        formattedObj["snxRedeemed"] = wei(obj["snxRedeemed"]);
    if (obj["amountLiquidated"])
        formattedObj["amountLiquidated"] = wei(obj["amountLiquidated"]);
    if (obj["liquidator"])
        formattedObj["liquidator"] = obj["liquidator"];
    if (obj["time"])
        formattedObj["time"] = wei(obj["time"], 0);
    return formattedObj as Pick<AccountLiquidatedResult, K>;
};
export const getAccountLiquidateds = async function <K extends keyof AccountLiquidatedResult>(url: string, options: MultiQueryOptions<AccountLiquidatedFilter, AccountLiquidatedResult>, args: AccountLiquidatedArgs<K>): Promise<Pick<AccountLiquidatedResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<AccountLiquidatedFilter, AccountLiquidatedResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof AccountLiquidatedFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type AccountRemovedFromLiquidationArgs<K extends keyof AccountRemovedFromLiquidationResult> = {
    [Property in keyof Pick<AccountRemovedFromLiquidationFields, K>]: AccountRemovedFromLiquidationFields[Property];
};
export const getAccountRemovedFromLiquidationById = async function <K extends keyof AccountRemovedFromLiquidationResult>(url: string, options: SingleQueryOptions, args: AccountRemovedFromLiquidationArgs<K>): Promise<Pick<AccountRemovedFromLiquidationResult, K>> {
    const res = await axios.post(url, {
...
export const getAccountRemovedFromLiquidations = async function <K extends keyof AccountRemovedFromLiquidationResult>(url: string, options: MultiQueryOptions<AccountRemovedFromLiquidationFilter, AccountRemovedFromLiquidationResult>, args: AccountRemovedFromLiquidationArgs<K>): Promise<Pick<AccountRemovedFromLiquidationResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<AccountRemovedFromLiquidationFilter, AccountRemovedFromLiquidationResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof AccountRemovedFromLiquidationFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getActiveStakerById = async function <K extends keyof ActiveStakerResult>(url: string, options: SingleQueryOptions, args: ActiveStakerArgs<K>): Promise<Pick<ActiveStakerResult, K>> {
    const res = await axios.post(url, {
...
export const getActiveStakers = async function <K extends keyof ActiveStakerResult>(url: string, options: MultiQueryOptions<ActiveStakerFilter, ActiveStakerResult>, args: ActiveStakerArgs<K>): Promise<Pick<ActiveStakerResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ActiveStakerFilter, ActiveStakerResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ActiveStakerFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getAtomicSynthExchangeById = async function <K extends keyof AtomicSynthExchangeResult>(url: string, options: SingleQueryOptions, args: AtomicSynthExchangeArgs<K>): Promise<Pick<AtomicSynthExchangeResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["fromAmount"])
        formattedObj["fromAmount"] = wei(obj["fromAmount"]);
    if (obj["fromAmountInUSD"])
        formattedObj["fromAmountInUSD"] = wei(obj["fromAmountInUSD"]);
    if (obj["toAmount"])
        formattedObj["toAmount"] = wei(obj["toAmount"]);
    if (obj["toAmountInUSD"])
        formattedObj["toAmountInUSD"] = wei(obj["toAmountInUSD"]);
    if (obj["feesInUSD"])
        formattedObj["feesInUSD"] = wei(obj["feesInUSD"]);
    if (obj["toAddress"])
...
export const getAtomicSynthExchanges = async function <K extends keyof AtomicSynthExchangeResult>(url: string, options: MultiQueryOptions<AtomicSynthExchangeFilter, AtomicSynthExchangeResult>, args: AtomicSynthExchangeArgs<K>): Promise<Pick<AtomicSynthExchangeResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<AtomicSynthExchangeFilter, AtomicSynthExchangeResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof AtomicSynthExchangeFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type BurnedFilter = {
    ...
    source_contains_nocase?: string | null;
    source_not_contains?: string | null;
    source_not_contains_nocase?: string | null;
    source_starts_with?: string | null;
    source_starts_with_nocase?: string | null;
    source_not_starts_with?: string | null;
    source_not_starts_with_nocase?: string | null;
    source_ends_with?: string | null;
    source_ends_with_nocase?: string | null;
    source_not_ends_with?: string | null;
    source_not_ends_with_nocase?: string | null;
    timestamp?: WeiSource | null;
    timestamp_not?: WeiSource | null;
    timestamp_gt?: WeiSource | null;
    timestamp_lt?: WeiSource | null;
...
export const getBurnedById = async function <K extends keyof BurnedResult>(url: string, options: SingleQueryOptions, args: BurnedArgs<K>): Promise<Pick<BurnedResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["account"])
        formattedObj["account"] = obj["account"];
    if (obj["value"])
        formattedObj["value"] = wei(obj["value"]);
    if (obj["source"])
    ...
    if (obj["gasPrice"])
        formattedObj["gasPrice"] = wei(obj["gasPrice"], 0);
    if (obj["block"])
        formattedObj["block"] = wei(obj["block"], 0);
    return formattedObj as Pick<BurnedResult, K>;
};
export const getBurneds = async function <K extends keyof BurnedResult>(url: string, options: MultiQueryOptions<BurnedFilter, BurnedResult>, args: BurnedArgs<K>): Promise<Pick<BurnedResult, K>[]> {
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof BurnedFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getCandleById = async function <K extends keyof CandleResult>(url: string, options: SingleQueryOptions, args: CandleArgs<K>): Promise<Pick<CandleResult, K>> {
    const res = await axios.post(url, {
...
export const getCandles = async function <K extends keyof CandleResult>(url: string, options: MultiQueryOptions<CandleFilter, CandleResult>, args: CandleArgs<K>): Promise<Pick<CandleResult, K>[]> {
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof CandleFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getCollateralDepositedById = async function <K extends keyof CollateralDepositedResult>(url: string, options: SingleQueryOptions, args: CollateralDepositedArgs<K>): Promise<Pick<CollateralDepositedResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["collateralAmount"])
        formattedObj["collateralAmount"] = wei(obj["collateralAmount"]);
    if (obj["collateralAfter"])
        formattedObj["collateralAfter"] = wei(obj["collateralAfter"]);
    if (obj["account"])
        formattedObj["account"] = obj["account"];
    if (obj["loanId"])
        formattedObj["loanId"] = wei(obj["loanId"], 0);
    if (obj["timestamp"])
        formattedObj["timestamp"] = wei(obj["timestamp"], 0);
    return formattedObj as Pick<CollateralDepositedResult, K>;
};
export const getCollateralDepositeds = async function <K extends keyof CollateralDepositedResult>(url: string, options: MultiQueryOptions<CollateralDepositedFilter, CollateralDepositedResult>, args: CollateralDepositedArgs<K>): Promise<Pick<CollateralDepositedResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<CollateralDepositedFilter, CollateralDepositedResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof CollateralDepositedFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getCollateralWithdrawnById = async function <K extends keyof CollateralWithdrawnResult>(url: string, options: SingleQueryOptions, args: CollateralWithdrawnArgs<K>): Promise<Pick<CollateralWithdrawnResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["amountWithdrawn"])
        formattedObj["amountWithdrawn"] = wei(obj["amountWithdrawn"]);
    if (obj["collateralAfter"])
        formattedObj["collateralAfter"] = wei(obj["collateralAfter"]);
    if (obj["account"])
        formattedObj["account"] = obj["account"];
...
export const getCollateralWithdrawns = async function <K extends keyof CollateralWithdrawnResult>(url: string, options: MultiQueryOptions<CollateralWithdrawnFilter, CollateralWithdrawnResult>, args: CollateralWithdrawnArgs<K>): Promise<Pick<CollateralWithdrawnResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<CollateralWithdrawnFilter, CollateralWithdrawnResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof CollateralWithdrawnFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getDailyBurnedById = async function <K extends keyof DailyBurnedResult>(url: string, options: SingleQueryOptions, args: DailyBurnedArgs<K>): Promise<Pick<DailyBurnedResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["value"])
        formattedObj["value"] = wei(obj["value"]);
    if (obj["totalDebt"])
        formattedObj["totalDebt"] = wei(obj["totalDebt"]);
    return formattedObj as Pick<DailyBurnedResult, K>;
};
export const getDailyBurneds = async function <K extends keyof DailyBurnedResult>(url: string, options: MultiQueryOptions<DailyBurnedFilter, DailyBurnedResult>, args: DailyBurnedArgs<K>): Promise<Pick<DailyBurnedResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<DailyBurnedFilter, DailyBurnedResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof DailyBurnedFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getDailyCandleById = async function <K extends keyof DailyCandleResult>(url: string, options: SingleQueryOptions, args: DailyCandleArgs<K>): Promise<Pick<DailyCandleResult, K>> {
    const res = await axios.post(url, {
...
export const getDailyCandles = async function <K extends keyof DailyCandleResult>(url: string, options: MultiQueryOptions<DailyCandleFilter, DailyCandleResult>, args: DailyCandleArgs<K>): Promise<Pick<DailyCandleResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<DailyCandleFilter, DailyCandleResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof DailyCandleFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type DailyExchangePartnerFilter = {
    ...
    partner_contains_nocase?: string | null;
    partner_not_contains?: string | null;
    partner_not_contains_nocase?: string | null;
    partner_starts_with?: string | null;
    partner_starts_with_nocase?: string | null;
    partner_not_starts_with?: string | null;
    partner_not_starts_with_nocase?: string | null;
...
export const getDailyExchangePartnerById = async function <K extends keyof DailyExchangePartnerResult>(url: string, options: SingleQueryOptions, args: DailyExchangePartnerArgs<K>): Promise<Pick<DailyExchangePartnerResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["id"])
        formattedObj["id"] = obj["id"];
    if (obj["usdVolume"])
        formattedObj["usdVolume"] = wei(obj["usdVolume"]);
    if (obj["usdFees"])
        formattedObj["usdFees"] = wei(obj["usdFees"]);
    if (obj["trades"])
...
export const getDailyExchangePartners = async function <K extends keyof DailyExchangePartnerResult>(url: string, options: MultiQueryOptions<DailyExchangePartnerFilter, DailyExchangePartnerResult>, args: DailyExchangePartnerArgs<K>): Promise<Pick<DailyExchangePartnerResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<DailyExchangePartnerFilter, DailyExchangePartnerResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof DailyExchangePartnerFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getDailyIssuedById = async function <K extends keyof DailyIssuedResult>(url: string, options: SingleQueryOptions, args: DailyIssuedArgs<K>): Promise<Pick<DailyIssuedResult, K>> {
    const res = await axios.post(url, {
...
export const getDailyIssueds = async function <K extends keyof DailyIssuedResult>(url: string, options: MultiQueryOptions<DailyIssuedFilter, DailyIssuedResult>, args: DailyIssuedArgs<K>): Promise<Pick<DailyIssuedResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<DailyIssuedFilter, DailyIssuedResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof DailyIssuedFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getDebtSnapshotById = async function <K extends keyof DebtSnapshotResult>(url: string, options: SingleQueryOptions, args: DebtSnapshotArgs<K>): Promise<Pick<DebtSnapshotResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["account"])
        formattedObj["account"] = obj["account"];
    if (obj["balanceOf"])
        formattedObj["balanceOf"] = wei(obj["balanceOf"]);
    if (obj["collateral"])
        formattedObj["collateral"] = wei(obj["collateral"]);
    if (obj["debtBalanceOf"])
        formattedObj["debtBalanceOf"] = wei(obj["debtBalanceOf"]);
...
export const getDebtSnapshots = async function <K extends keyof DebtSnapshotResult>(url: string, options: MultiQueryOptions<DebtSnapshotFilter, DebtSnapshotResult>, args: DebtSnapshotArgs<K>): Promise<Pick<DebtSnapshotResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<DebtSnapshotFilter, DebtSnapshotResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof DebtSnapshotFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getDebtStateById = async function <K extends keyof DebtStateResult>(url: string, options: SingleQueryOptions, args: DebtStateArgs<K>): Promise<Pick<DebtStateResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["timestamp"])
        formattedObj["timestamp"] = wei(obj["timestamp"], 0);
    if (obj["debtEntry"])
        formattedObj["debtEntry"] = wei(obj["debtEntry"]);
    if (obj["totalIssuedSynths"])
        formattedObj["totalIssuedSynths"] = wei(obj["totalIssuedSynths"]);
    if (obj["debtRatio"])
        formattedObj["debtRatio"] = wei(obj["debtRatio"]);
    return formattedObj as Pick<DebtStateResult, K>;
};
export const getDebtStates = async function <K extends keyof DebtStateResult>(url: string, options: MultiQueryOptions<DebtStateFilter, DebtStateResult>, args: DebtStateArgs<K>): Promise<Pick<DebtStateResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<DebtStateFilter, DebtStateResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof DebtStateFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getDelegatedWalletById = async function <K extends keyof DelegatedWalletResult>(url: string, options: SingleQueryOptions, args: DelegatedWalletArgs<K>): Promise<Pick<DelegatedWalletResult, K>> {
    const res = await axios.post(url, {
...
export const getDelegatedWallets = async function <K extends keyof DelegatedWalletResult>(url: string, options: MultiQueryOptions<DelegatedWalletFilter, DelegatedWalletResult>, args: DelegatedWalletArgs<K>): Promise<Pick<DelegatedWalletResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<DelegatedWalletFilter, DelegatedWalletResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof DelegatedWalletFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getExchangeEntryAppendedById = async function <K extends keyof ExchangeEntryAppendedResult>(url: string, options: SingleQueryOptions, args: ExchangeEntryAppendedArgs<K>): Promise<Pick<ExchangeEntryAppendedResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["amount"])
        formattedObj["amount"] = wei(obj["amount"]);
    if (obj["dest"])
        formattedObj["dest"] = obj["dest"];
    if (obj["amountReceived"])
        formattedObj["amountReceived"] = wei(obj["amountReceived"]);
    if (obj["exchangeFeeRate"])
        formattedObj["exchangeFeeRate"] = wei(obj["exchangeFeeRate"]);
    if (obj["roundIdForSrc"])
        formattedObj["roundIdForSrc"] = wei(obj["roundIdForSrc"], 0);
    if (obj["roundIdForDest"])
        formattedObj["roundIdForDest"] = wei(obj["roundIdForDest"], 0);
    return formattedObj as Pick<ExchangeEntryAppendedResult, K>;
};
export const getExchangeEntryAppendeds = async function <K extends keyof ExchangeEntryAppendedResult>(url: string, options: MultiQueryOptions<ExchangeEntryAppendedFilter, ExchangeEntryAppendedResult>, args: ExchangeEntryAppendedArgs<K>): Promise<Pick<ExchangeEntryAppendedResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ExchangeEntryAppendedFilter, ExchangeEntryAppendedResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ExchangeEntryAppendedFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getExchangeEntrySettledById = async function <K extends keyof ExchangeEntrySettledResult>(url: string, options: SingleQueryOptions, args: ExchangeEntrySettledArgs<K>): Promise<Pick<ExchangeEntrySettledResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["dest"])
        formattedObj["dest"] = obj["dest"];
    if (obj["reclaim"])
        formattedObj["reclaim"] = wei(obj["reclaim"]);
    if (obj["rebate"])
        formattedObj["rebate"] = wei(obj["rebate"]);
...
export const getExchangeEntrySettleds = async function <K extends keyof ExchangeEntrySettledResult>(url: string, options: MultiQueryOptions<ExchangeEntrySettledFilter, ExchangeEntrySettledResult>, args: ExchangeEntrySettledArgs<K>): Promise<Pick<ExchangeEntrySettledResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ExchangeEntrySettledFilter, ExchangeEntrySettledResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ExchangeEntrySettledFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getExchangeFeeById = async function <K extends keyof ExchangeFeeResult>(url: string, options: SingleQueryOptions, args: ExchangeFeeArgs<K>): Promise<Pick<ExchangeFeeResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["id"])
        formattedObj["id"] = obj["id"];
    if (obj["fee"])
        formattedObj["fee"] = wei(obj["fee"]);
    return formattedObj as Pick<ExchangeFeeResult, K>;
};
export const getExchangeFees = async function <K extends keyof ExchangeFeeResult>(url: string, options: MultiQueryOptions<ExchangeFeeFilter, ExchangeFeeResult>, args: ExchangeFeeArgs<K>): Promise<Pick<ExchangeFeeResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ExchangeFeeFilter, ExchangeFeeResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ExchangeFeeFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getExchangePartnerById = async function <K extends keyof ExchangePartnerResult>(url: string, options: SingleQueryOptions, args: ExchangePartnerArgs<K>): Promise<Pick<ExchangePartnerResult, K>> {
    const res = await axios.post(url, {
...
export const getExchangePartners = async function <K extends keyof ExchangePartnerResult>(url: string, options: MultiQueryOptions<ExchangePartnerFilter, ExchangePartnerResult>, args: ExchangePartnerArgs<K>): Promise<Pick<ExchangePartnerResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ExchangePartnerFilter, ExchangePartnerResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ExchangePartnerFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getExchangeRebateById = async function <K extends keyof ExchangeRebateResult>(url: string, options: SingleQueryOptions, args: ExchangeRebateArgs<K>): Promise<Pick<ExchangeRebateResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["amount"])
        formattedObj["amount"] = wei(obj["amount"]);
    if (obj["amountInUSD"])
        formattedObj["amountInUSD"] = wei(obj["amountInUSD"]);
    if (obj["timestamp"])
        formattedObj["timestamp"] = wei(obj["timestamp"], 0);
    if (obj["gasPrice"])
        formattedObj["gasPrice"] = wei(obj["gasPrice"], 0);
...
export const getExchangeRebates = async function <K extends keyof ExchangeRebateResult>(url: string, options: MultiQueryOptions<ExchangeRebateFilter, ExchangeRebateResult>, args: ExchangeRebateArgs<K>): Promise<Pick<ExchangeRebateResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ExchangeRebateFilter, ExchangeRebateResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ExchangeRebateFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getExchangeReclaimById = async function <K extends keyof ExchangeReclaimResult>(url: string, options: SingleQueryOptions, args: ExchangeReclaimArgs<K>): Promise<Pick<ExchangeReclaimResult, K>> {
    const res = await axios.post(url, {
...
export const getExchangeReclaims = async function <K extends keyof ExchangeReclaimResult>(url: string, options: MultiQueryOptions<ExchangeReclaimFilter, ExchangeReclaimResult>, args: ExchangeReclaimArgs<K>): Promise<Pick<ExchangeReclaimResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ExchangeReclaimFilter, ExchangeReclaimResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ExchangeReclaimFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getExchangerById = async function <K extends keyof ExchangerResult>(url: string, options: SingleQueryOptions, args: ExchangerArgs<K>): Promise<Pick<ExchangerResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["bucketMagnitude"])
        formattedObj["bucketMagnitude"] = wei(obj["bucketMagnitude"], 0);
    if (obj["synth"])
        formattedObj["synth"] = obj["synth"];
    if (obj["firstSeen"])
        formattedObj["firstSeen"] = wei(obj["firstSeen"], 0);
    if (obj["lastSeen"])
        formattedObj["lastSeen"] = wei(obj["lastSeen"], 0);
    if (obj["trades"])
        formattedObj["trades"] = wei(obj["trades"], 0);
...
export const getExchangers = async function <K extends keyof ExchangerResult>(url: string, options: MultiQueryOptions<ExchangerFilter, ExchangerResult>, args: ExchangerArgs<K>): Promise<Pick<ExchangerResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ExchangerFilter, ExchangerResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ExchangerFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getFeePeriodById = async function <K extends keyof FeePeriodResult>(url: string, options: SingleQueryOptions, args: FeePeriodArgs<K>): Promise<Pick<FeePeriodResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["id"])
        formattedObj["id"] = obj["id"];
    if (obj["startTime"])
        formattedObj["startTime"] = wei(obj["startTime"], 0);
    if (obj["feesToDistribute"])
        formattedObj["feesToDistribute"] = wei(obj["feesToDistribute"]);
    if (obj["feesClaimed"])
        formattedObj["feesClaimed"] = wei(obj["feesClaimed"]);
    if (obj["rewardsToDistribute"])
        formattedObj["rewardsToDistribute"] = wei(obj["rewardsToDistribute"]);
    if (obj["rewardsClaimed"])
        formattedObj["rewardsClaimed"] = wei(obj["rewardsClaimed"]);
    return formattedObj as Pick<FeePeriodResult, K>;
};
export const getFeePeriods = async function <K extends keyof FeePeriodResult>(url: string, options: MultiQueryOptions<FeePeriodFilter, FeePeriodResult>, args: FeePeriodArgs<K>): Promise<Pick<FeePeriodResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<FeePeriodFilter, FeePeriodResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof FeePeriodFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getFeesClaimedById = async function <K extends keyof FeesClaimedResult>(url: string, options: SingleQueryOptions, args: FeesClaimedArgs<K>): Promise<Pick<FeesClaimedResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["value"])
        formattedObj["value"] = wei(obj["value"]);
    if (obj["rewards"])
        formattedObj["rewards"] = wei(obj["rewards"]);
    if (obj["block"])
        formattedObj["block"] = wei(obj["block"], 0);
    if (obj["timestamp"])
        formattedObj["timestamp"] = wei(obj["timestamp"], 0);
...
export const getFeesClaimeds = async function <K extends keyof FeesClaimedResult>(url: string, options: MultiQueryOptions<FeesClaimedFilter, FeesClaimedResult>, args: FeesClaimedArgs<K>): Promise<Pick<FeesClaimedResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<FeesClaimedFilter, FeesClaimedResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof FeesClaimedFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getInversePricingInfoById = async function <K extends keyof InversePricingInfoResult>(url: string, options: SingleQueryOptions, args: InversePricingInfoArgs<K>): Promise<Pick<InversePricingInfoResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["upperLimit"])
        formattedObj["upperLimit"] = wei(obj["upperLimit"]);
    if (obj["lowerLimit"])
        formattedObj["lowerLimit"] = wei(obj["lowerLimit"]);
    if (obj["entryPoint"])
        formattedObj["entryPoint"] = wei(obj["entryPoint"]);
    return formattedObj as Pick<InversePricingInfoResult, K>;
};
export const getInversePricingInfos = async function <K extends keyof InversePricingInfoResult>(url: string, options: MultiQueryOptions<InversePricingInfoFilter, InversePricingInfoResult>, args: InversePricingInfoArgs<K>): Promise<Pick<InversePricingInfoResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<InversePricingInfoFilter, InversePricingInfoResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof InversePricingInfoFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getIssuedById = async function <K extends keyof IssuedResult>(url: string, options: SingleQueryOptions, args: IssuedArgs<K>): Promise<Pick<IssuedResult, K>> {
    const res = await axios.post(url, {
...
export const getIssueds = async function <K extends keyof IssuedResult>(url: string, options: MultiQueryOptions<IssuedFilter, IssuedResult>, args: IssuedArgs<K>): Promise<Pick<IssuedResult, K>[]> {
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof IssuedFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getIssuerById = async function <K extends keyof IssuerResult>(url: string, options: SingleQueryOptions, args: IssuerArgs<K>): Promise<Pick<IssuerResult, K>> {
    const res = await axios.post(url, {
...
export const getIssuers = async function <K extends keyof IssuerResult>(url: string, options: MultiQueryOptions<IssuerFilter, IssuerResult>, args: IssuerArgs<K>): Promise<Pick<IssuerResult, K>[]> {
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof IssuerFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getLatestRateById = async function <K extends keyof LatestRateResult>(url: string, options: SingleQueryOptions, args: LatestRateArgs<K>): Promise<Pick<LatestRateResult, K>> {
    const res = await axios.post(url, {
...
export const getLatestRates = async function <K extends keyof LatestRateResult>(url: string, options: MultiQueryOptions<LatestRateFilter, LatestRateResult>, args: LatestRateArgs<K>): Promise<Pick<LatestRateResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<LatestRateFilter, LatestRateResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof LatestRateFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getLatestSynthBalanceById = async function <K extends keyof LatestSynthBalanceResult>(url: string, options: SingleQueryOptions, args: LatestSynthBalanceArgs<K>): Promise<Pick<LatestSynthBalanceResult, K>> {
    const res = await axios.post(url, {
...
export const getLatestSynthBalances = async function <K extends keyof LatestSynthBalanceResult>(url: string, options: MultiQueryOptions<LatestSynthBalanceFilter, LatestSynthBalanceResult>, args: LatestSynthBalanceArgs<K>): Promise<Pick<LatestSynthBalanceResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<LatestSynthBalanceFilter, LatestSynthBalanceResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof LatestSynthBalanceFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type LoanFilter = {
    ...
    currency_contains_nocase?: string | null;
    currency_not_contains?: string | null;
    currency_not_contains_nocase?: string | null;
    currency_starts_with?: string | null;
    currency_starts_with_nocase?: string | null;
    currency_not_starts_with?: string | null;
    currency_not_starts_with_nocase?: string | null;
    currency_ends_with?: string | null;
    currency_ends_with_nocase?: string | null;
    currency_not_ends_with?: string | null;
    currency_not_ends_with_nocase?: string | null;
    ...
    collateralMinted_contains_nocase?: string | null;
    collateralMinted_not_contains?: string | null;
    collateralMinted_not_contains_nocase?: string | null;
    collateralMinted_starts_with?: string | null;
    collateralMinted_starts_with_nocase?: string | null;
    collateralMinted_not_starts_with?: string | null;
    collateralMinted_not_starts_with_nocase?: string | null;
    collateralMinted_ends_with?: string | null;
    collateralMinted_ends_with_nocase?: string | null;
    collateralMinted_not_ends_with?: string | null;
    collateralMinted_not_ends_with_nocase?: string | null;
    amount?: WeiSource | null;
    amount_not?: WeiSource | null;
    amount_gt?: WeiSource | null;
    amount_lt?: WeiSource | null;
...
export const getLoanById = async function <K extends keyof LoanResult>(url: string, options: SingleQueryOptions, args: LoanArgs<K>): Promise<Pick<LoanResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["account"])
        formattedObj["account"] = obj["account"];
    if (obj["currency"])
        formattedObj["currency"] = obj["currency"];
    ...
    if (obj["closedAt"])
        formattedObj["closedAt"] = wei(obj["closedAt"], 0);
...
export const getLoans = async function <K extends keyof LoanResult>(url: string, options: MultiQueryOptions<LoanFilter, LoanResult>, args: LoanArgs<K>): Promise<Pick<LoanResult, K>[]> {
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof LoanFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getLoanLiquidatedById = async function <K extends keyof LoanLiquidatedResult>(url: string, options: SingleQueryOptions, args: LoanLiquidatedArgs<K>): Promise<Pick<LoanLiquidatedResult, K>> {
    const res = await axios.post(url, {
...
export const getLoanLiquidateds = async function <K extends keyof LoanLiquidatedResult>(url: string, options: MultiQueryOptions<LoanLiquidatedFilter, LoanLiquidatedResult>, args: LoanLiquidatedArgs<K>): Promise<Pick<LoanLiquidatedResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<LoanLiquidatedFilter, LoanLiquidatedResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof LoanLiquidatedFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type LoanPartiallyLiquidatedArgs<K extends keyof LoanPartiallyLiquidatedResult> = {
    [Property in keyof Pick<LoanPartiallyLiquidatedFields, K>]: LoanPartiallyLiquidatedFields[Property];
};
export const getLoanPartiallyLiquidatedById = async function <K extends keyof LoanPartiallyLiquidatedResult>(url: string, options: SingleQueryOptions, args: LoanPartiallyLiquidatedArgs<K>): Promise<Pick<LoanPartiallyLiquidatedResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["liquidatedAmount"])
        formattedObj["liquidatedAmount"] = wei(obj["liquidatedAmount"]);
...
export const getLoanPartiallyLiquidateds = async function <K extends keyof LoanPartiallyLiquidatedResult>(url: string, options: MultiQueryOptions<LoanPartiallyLiquidatedFilter, LoanPartiallyLiquidatedResult>, args: LoanPartiallyLiquidatedArgs<K>): Promise<Pick<LoanPartiallyLiquidatedResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<LoanPartiallyLiquidatedFilter, LoanPartiallyLiquidatedResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof LoanPartiallyLiquidatedFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getLoanRepaidById = async function <K extends keyof LoanRepaidResult>(url: string, options: SingleQueryOptions, args: LoanRepaidArgs<K>): Promise<Pick<LoanRepaidResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["id"])
        formattedObj["id"] = obj["id"];
    if (obj["repaidAmount"])
        formattedObj["repaidAmount"] = wei(obj["repaidAmount"]);
    if (obj["newLoanAmount"])
        formattedObj["newLoanAmount"] = wei(obj["newLoanAmount"]);
    if (obj["account"])
        formattedObj["account"] = obj["account"];
    if (obj["loanId"])
        formattedObj["loanId"] = wei(obj["loanId"], 0);
...
export const getLoanRepaids = async function <K extends keyof LoanRepaidResult>(url: string, options: MultiQueryOptions<LoanRepaidFilter, LoanRepaidResult>, args: LoanRepaidArgs<K>): Promise<Pick<LoanRepaidResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<LoanRepaidFilter, LoanRepaidResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof LoanRepaidFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getRateUpdateById = async function <K extends keyof RateUpdateResult>(url: string, options: SingleQueryOptions, args: RateUpdateArgs<K>): Promise<Pick<RateUpdateResult, K>> {
    const res = await axios.post(url, {
...
export const getRateUpdates = async function <K extends keyof RateUpdateResult>(url: string, options: MultiQueryOptions<RateUpdateFilter, RateUpdateResult>, args: RateUpdateArgs<K>): Promise<Pick<RateUpdateResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<RateUpdateFilter, RateUpdateResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof RateUpdateFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getRewardEscrowHolderById = async function <K extends keyof RewardEscrowHolderResult>(url: string, options: SingleQueryOptions, args: RewardEscrowHolderArgs<K>): Promise<Pick<RewardEscrowHolderResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["vestedBalanceOf"])
        formattedObj["vestedBalanceOf"] = wei(obj["vestedBalanceOf"]);
    return formattedObj as Pick<RewardEscrowHolderResult, K>;
};
export const getRewardEscrowHolders = async function <K extends keyof RewardEscrowHolderResult>(url: string, options: MultiQueryOptions<RewardEscrowHolderFilter, RewardEscrowHolderResult>, args: RewardEscrowHolderArgs<K>): Promise<Pick<RewardEscrowHolderResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<RewardEscrowHolderFilter, RewardEscrowHolderResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof RewardEscrowHolderFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getSNXHolderById = async function <K extends keyof SNXHolderResult>(url: string, options: SingleQueryOptions, args: SNXHolderArgs<K>): Promise<Pick<SNXHolderResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["collateral"])
        formattedObj["collateral"] = wei(obj["collateral"]);
    if (obj["transferable"])
        formattedObj["transferable"] = wei(obj["transferable"]);
    if (obj["initialDebtOwnership"])
        formattedObj["initialDebtOwnership"] = wei(obj["initialDebtOwnership"], 0);
    if (obj["debtEntryAtIndex"])
        formattedObj["debtEntryAtIndex"] = wei(obj["debtEntryAtIndex"], 0);
    if (obj["claims"])
        formattedObj["claims"] = wei(obj["claims"], 0);
    if (obj["mints"])
        formattedObj["mints"] = wei(obj["mints"], 0);
    return formattedObj as Pick<SNXHolderResult, K>;
};
export const getSNXHolders = async function <K extends keyof SNXHolderResult>(url: string, options: MultiQueryOptions<SNXHolderFilter, SNXHolderResult>, args: SNXHolderArgs<K>): Promise<Pick<SNXHolderResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<SNXHolderFilter, SNXHolderResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof SNXHolderFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type ShortFilter = {
    ...
    contractData_contains_nocase?: string | null;
    contractData_not_contains?: string | null;
    contractData_not_contains_nocase?: string | null;
    contractData_starts_with?: string | null;
    contractData_starts_with_nocase?: string | null;
    contractData_not_starts_with?: string | null;
    contractData_not_starts_with_nocase?: string | null;
...
export const getShortById = async function <K extends keyof ShortResult>(url: string, options: SingleQueryOptions, args: ShortArgs<K>): Promise<Pick<ShortResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["accruedInterestLastUpdateTimestamp"])
        formattedObj["accruedInterestLastUpdateTimestamp"] = wei(obj["accruedInterestLastUpdateTimestamp"], 0);
    if (obj["isOpen"])
        formattedObj["isOpen"] = obj["isOpen"];
    if (obj["createdAtBlock"])
        formattedObj["createdAtBlock"] = wei(obj["createdAtBlock"], 0);
    if (obj["createdAt"])
        formattedObj["createdAt"] = wei(obj["createdAt"], 0);
    if (obj["closedAt"])
        formattedObj["closedAt"] = wei(obj["closedAt"], 0);
...
export const getShorts = async function <K extends keyof ShortResult>(url: string, options: MultiQueryOptions<ShortFilter, ShortResult>, args: ShortArgs<K>): Promise<Pick<ShortResult, K>[]> {
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ShortFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type ShortCollateralChangeFilter = {
    ...
    short_contains_nocase?: string | null;
    short_not_contains?: string | null;
    short_not_contains_nocase?: string | null;
    short_starts_with?: string | null;
    short_starts_with_nocase?: string | null;
    short_not_starts_with?: string | null;
    short_not_starts_with_nocase?: string | null;
...
export const getShortCollateralChangeById = async function <K extends keyof ShortCollateralChangeResult>(url: string, options: SingleQueryOptions, args: ShortCollateralChangeArgs<K>): Promise<Pick<ShortCollateralChangeResult, K>> {
    const res = await axios.post(url, {
...
export const getShortCollateralChanges = async function <K extends keyof ShortCollateralChangeResult>(url: string, options: MultiQueryOptions<ShortCollateralChangeFilter, ShortCollateralChangeResult>, args: ShortCollateralChangeArgs<K>): Promise<Pick<ShortCollateralChangeResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ShortCollateralChangeFilter, ShortCollateralChangeResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ShortCollateralChangeFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getShortContractById = async function <K extends keyof ShortContractResult>(url: string, options: SingleQueryOptions, args: ShortContractArgs<K>): Promise<Pick<ShortContractResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["minCratio"])
        formattedObj["minCratio"] = wei(obj["minCratio"], 0);
    if (obj["minCollateral"])
        formattedObj["minCollateral"] = wei(obj["minCollateral"]);
    if (obj["issueFeeRate"])
        formattedObj["issueFeeRate"] = wei(obj["issueFeeRate"]);
...
export const getShortContracts = async function <K extends keyof ShortContractResult>(url: string, options: MultiQueryOptions<ShortContractFilter, ShortContractResult>, args: ShortContractArgs<K>): Promise<Pick<ShortContractResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ShortContractFilter, ShortContractResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ShortContractFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type ShortContractUpdateFilter = {
    ...
    field_contains_nocase?: string | null;
    field_not_contains?: string | null;
    field_not_contains_nocase?: string | null;
    field_starts_with?: string | null;
    field_starts_with_nocase?: string | null;
    field_not_starts_with?: string | null;
    field_not_starts_with_nocase?: string | null;
    field_ends_with?: string | null;
    field_ends_with_nocase?: string | null;
    field_not_ends_with?: string | null;
    field_not_ends_with_nocase?: string | null;
    value?: string | null;
    ...
    value_contains_nocase?: string | null;
    value_not_contains?: string | null;
    value_not_contains_nocase?: string | null;
    value_starts_with?: string | null;
    value_starts_with_nocase?: string | null;
    value_not_starts_with?: string | null;
    value_not_starts_with_nocase?: string | null;
    value_ends_with?: string | null;
    value_ends_with_nocase?: string | null;
    value_not_ends_with?: string | null;
    value_not_ends_with_nocase?: string | null;
    contractData?: string | null;
    contractData_not?: string | null;
    contractData_gt?: string | null;
    contractData_lt?: string | null;
...
export const getShortContractUpdateById = async function <K extends keyof ShortContractUpdateResult>(url: string, options: SingleQueryOptions, args: ShortContractUpdateArgs<K>): Promise<Pick<ShortContractUpdateResult, K>> {
    const res = await axios.post(url, {
...
export const getShortContractUpdates = async function <K extends keyof ShortContractUpdateResult>(url: string, options: MultiQueryOptions<ShortContractUpdateFilter, ShortContractUpdateResult>, args: ShortContractUpdateArgs<K>): Promise<Pick<ShortContractUpdateResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ShortContractUpdateFilter, ShortContractUpdateResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ShortContractUpdateFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getShortLiquidationById = async function <K extends keyof ShortLiquidationResult>(url: string, options: SingleQueryOptions, args: ShortLiquidationArgs<K>): Promise<Pick<ShortLiquidationResult, K>> {
    const res = await axios.post(url, {
...
export const getShortLiquidations = async function <K extends keyof ShortLiquidationResult>(url: string, options: MultiQueryOptions<ShortLiquidationFilter, ShortLiquidationResult>, args: ShortLiquidationArgs<K>): Promise<Pick<ShortLiquidationResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ShortLiquidationFilter, ShortLiquidationResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ShortLiquidationFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getShortLoanChangeById = async function <K extends keyof ShortLoanChangeResult>(url: string, options: SingleQueryOptions, args: ShortLoanChangeArgs<K>): Promise<Pick<ShortLoanChangeResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["amount"])
        formattedObj["amount"] = wei(obj["amount"]);
    if (obj["loanAfter"])
        formattedObj["loanAfter"] = wei(obj["loanAfter"]);
    if (obj["short"])
        formattedObj["short"] = obj["short"];
    if (obj["rate"])
        formattedObj["rate"] = wei(obj["rate"]);
...
export const getShortLoanChanges = async function <K extends keyof ShortLoanChangeResult>(url: string, options: MultiQueryOptions<ShortLoanChangeFilter, ShortLoanChangeResult>, args: ShortLoanChangeArgs<K>): Promise<Pick<ShortLoanChangeResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<ShortLoanChangeFilter, ShortLoanChangeResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof ShortLoanChangeFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getSynthById = async function <K extends keyof SynthResult>(url: string, options: SingleQueryOptions, args: SynthArgs<K>): Promise<Pick<SynthResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["totalSupply"])
        formattedObj["totalSupply"] = wei(obj["totalSupply"]);
    return formattedObj as Pick<SynthResult, K>;
};
export const getSynths = async function <K extends keyof SynthResult>(url: string, options: MultiQueryOptions<SynthFilter, SynthResult>, args: SynthArgs<K>): Promise<Pick<SynthResult, K>[]> {
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof SynthFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getSynthBalanceById = async function <K extends keyof SynthBalanceResult>(url: string, options: SingleQueryOptions, args: SynthBalanceArgs<K>): Promise<Pick<SynthBalanceResult, K>> {
    const res = await axios.post(url, {
...
export const getSynthBalances = async function <K extends keyof SynthBalanceResult>(url: string, options: MultiQueryOptions<SynthBalanceFilter, SynthBalanceResult>, args: SynthBalanceArgs<K>): Promise<Pick<SynthBalanceResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<SynthBalanceFilter, SynthBalanceResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof SynthBalanceFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getSynthByCurrencyKeyById = async function <K extends keyof SynthByCurrencyKeyResult>(url: string, options: SingleQueryOptions, args: SynthByCurrencyKeyArgs<K>): Promise<Pick<SynthByCurrencyKeyResult, K>> {
    const res = await axios.post(url, {
...
export const getSynthByCurrencyKeys = async function <K extends keyof SynthByCurrencyKeyResult>(url: string, options: MultiQueryOptions<SynthByCurrencyKeyFilter, SynthByCurrencyKeyResult>, args: SynthByCurrencyKeyArgs<K>): Promise<Pick<SynthByCurrencyKeyResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<SynthByCurrencyKeyFilter, SynthByCurrencyKeyResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof SynthByCurrencyKeyFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getSynthExchangeById = async function <K extends keyof SynthExchangeResult>(url: string, options: SingleQueryOptions, args: SynthExchangeArgs<K>): Promise<Pick<SynthExchangeResult, K>> {
    const res = await axios.post(url, {
...
export const getSynthExchanges = async function <K extends keyof SynthExchangeResult>(url: string, options: MultiQueryOptions<SynthExchangeFilter, SynthExchangeResult>, args: SynthExchangeArgs<K>): Promise<Pick<SynthExchangeResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<SynthExchangeFilter, SynthExchangeResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof SynthExchangeFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getSynthetixById = async function <K extends keyof SynthetixResult>(url: string, options: SingleQueryOptions, args: SynthetixArgs<K>): Promise<Pick<SynthetixResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["id"])
        formattedObj["id"] = obj["id"];
    if (obj["issuers"])
        formattedObj["issuers"] = wei(obj["issuers"], 0);
    if (obj["snxHolders"])
        formattedObj["snxHolders"] = wei(obj["snxHolders"], 0);
    return formattedObj as Pick<SynthetixResult, K>;
};
export const getSynthetixs = async function <K extends keyof SynthetixResult>(url: string, options: MultiQueryOptions<SynthetixFilter, SynthetixResult>, args: SynthetixArgs<K>): Promise<Pick<SynthetixResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<SynthetixFilter, SynthetixResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof SynthetixFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type SystemSettingFilter = {
    ...
    aggregatorWarningFlags_contains_nocase?: string | null;
    aggregatorWarningFlags_not_contains?: string | null;
    aggregatorWarningFlags_not_contains_nocase?: string | null;
    aggregatorWarningFlags_starts_with?: string | null;
    aggregatorWarningFlags_starts_with_nocase?: string | null;
    aggregatorWarningFlags_not_starts_with?: string | null;
    aggregatorWarningFlags_not_starts_with_nocase?: string | null;
    aggregatorWarningFlags_ends_with?: string | null;
    aggregatorWarningFlags_ends_with_nocase?: string | null;
    aggregatorWarningFlags_not_ends_with?: string | null;
    aggregatorWarningFlags_not_ends_with_nocase?: string | null;
...
export const getSystemSettingById = async function <K extends keyof SystemSettingResult>(url: string, options: SingleQueryOptions, args: SystemSettingArgs<K>): Promise<Pick<SystemSettingResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["issuanceRatio"])
        formattedObj["issuanceRatio"] = wei(obj["issuanceRatio"]);
    if (obj["feePeriodDuration"])
        formattedObj["feePeriodDuration"] = wei(obj["feePeriodDuration"], 0);
    if (obj["targetThreshold"])
        formattedObj["targetThreshold"] = wei(obj["targetThreshold"]);
    if (obj["liquidationDelay"])
        formattedObj["liquidationDelay"] = wei(obj["liquidationDelay"], 0);
    if (obj["liquidationRatio"])
        formattedObj["liquidationRatio"] = wei(obj["liquidationRatio"]);
    if (obj["liquidationPenalty"])
        formattedObj["liquidationPenalty"] = wei(obj["liquidationPenalty"]);
    if (obj["rateStalePeriod"])
        formattedObj["rateStalePeriod"] = wei(obj["rateStalePeriod"], 0);
...
export const getSystemSettings = async function <K extends keyof SystemSettingResult>(url: string, options: MultiQueryOptions<SystemSettingFilter, SystemSettingResult>, args: SystemSettingArgs<K>): Promise<Pick<SystemSettingResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<SystemSettingFilter, SystemSettingResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof SystemSettingFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type TemporaryExchangePartnerTrackerArgs<K extends keyof TemporaryExchangePartnerTrackerResult> = {
    [Property in keyof Pick<TemporaryExchangePartnerTrackerFields, K>]: TemporaryExchangePartnerTrackerFields[Property];
};
export const getTemporaryExchangePartnerTrackerById = async function <K extends keyof TemporaryExchangePartnerTrackerResult>(url: string, options: SingleQueryOptions, args: TemporaryExchangePartnerTrackerArgs<K>): Promise<Pick<TemporaryExchangePartnerTrackerResult, K>> {
    const res = await axios.post(url, {
...
export const getTemporaryExchangePartnerTrackers = async function <K extends keyof TemporaryExchangePartnerTrackerResult>(url: string, options: MultiQueryOptions<TemporaryExchangePartnerTrackerFilter, TemporaryExchangePartnerTrackerResult>, args: TemporaryExchangePartnerTrackerArgs<K>): Promise<Pick<TemporaryExchangePartnerTrackerResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<TemporaryExchangePartnerTrackerFilter, TemporaryExchangePartnerTrackerResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof TemporaryExchangePartnerTrackerFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getTotalById = async function <K extends keyof TotalResult>(url: string, options: SingleQueryOptions, args: TotalArgs<K>): Promise<Pick<TotalResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["newExchangers"])
        formattedObj["newExchangers"] = wei(obj["newExchangers"], 0);
    if (obj["exchangers"])
        formattedObj["exchangers"] = wei(obj["exchangers"], 0);
    if (obj["exchangeUSDTally"])
        formattedObj["exchangeUSDTally"] = wei(obj["exchangeUSDTally"]);
    if (obj["totalFeesGeneratedInUSD"])
        formattedObj["totalFeesGeneratedInUSD"] = wei(obj["totalFeesGeneratedInUSD"]);
...
export const getTotals = async function <K extends keyof TotalResult>(url: string, options: MultiQueryOptions<TotalFilter, TotalResult>, args: TotalArgs<K>): Promise<Pick<TotalResult, K>[]> {
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof TotalFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getTotalActiveStakerById = async function <K extends keyof TotalActiveStakerResult>(url: string, options: SingleQueryOptions, args: TotalActiveStakerArgs<K>): Promise<Pick<TotalActiveStakerResult, K>> {
    const res = await axios.post(url, {
...
export const getTotalActiveStakers = async function <K extends keyof TotalActiveStakerResult>(url: string, options: MultiQueryOptions<TotalActiveStakerFilter, TotalActiveStakerResult>, args: TotalActiveStakerArgs<K>): Promise<Pick<TotalActiveStakerResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<TotalActiveStakerFilter, TotalActiveStakerResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof TotalActiveStakerFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getTotalDailyActiveStakerById = async function <K extends keyof TotalDailyActiveStakerResult>(url: string, options: SingleQueryOptions, args: TotalDailyActiveStakerArgs<K>): Promise<Pick<TotalDailyActiveStakerResult, K>> {
    const res = await axios.post(url, {
...
export const getTotalDailyActiveStakers = async function <K extends keyof TotalDailyActiveStakerResult>(url: string, options: MultiQueryOptions<TotalDailyActiveStakerFilter, TotalDailyActiveStakerResult>, args: TotalDailyActiveStakerArgs<K>): Promise<Pick<TotalDailyActiveStakerResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<TotalDailyActiveStakerFilter, TotalDailyActiveStakerResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof TotalDailyActiveStakerFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type WrapperFilter = {
    ...
    tokenAddress_contains_nocase?: string | null;
    tokenAddress_not_contains?: string | null;
    tokenAddress_not_contains_nocase?: string | null;
    tokenAddress_starts_with?: string | null;
    tokenAddress_starts_with_nocase?: string | null;
    tokenAddress_not_starts_with?: string | null;
    tokenAddress_not_starts_with_nocase?: string | null;
    tokenAddress_ends_with?: string | null;
    tokenAddress_ends_with_nocase?: string | null;
    tokenAddress_not_ends_with?: string | null;
    tokenAddress_not_ends_with_nocase?: string | null;
    amount?: WeiSource | null;
    amount_not?: WeiSource | null;
    amount_gt?: WeiSource | null;
    amount_lt?: WeiSource | null;
    ...
    currencyKey_not_in?: string[];
    currencyKey_contains?: string | null;
    currencyKey_contains_nocase?: string | null;
    currencyKey_not_contains?: string | null;
    currencyKey_not_contains_nocase?: string | null;
    currencyKey_starts_with?: string | null;
    currencyKey_starts_with_nocase?: string | null;
    currencyKey_not_starts_with?: string | null;
    currencyKey_not_starts_with_nocase?: string | null;
    currencyKey_ends_with?: string | null;
    currencyKey_ends_with_nocase?: string | null;
    currencyKey_not_ends_with?: string | null;
    currencyKey_not_ends_with_nocase?: string | null;
...
export const getWrapperById = async function <K extends keyof WrapperResult>(url: string, options: SingleQueryOptions, args: WrapperArgs<K>): Promise<Pick<WrapperResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["amountInUSD"])
        formattedObj["amountInUSD"] = wei(obj["amountInUSD"]);
    if (obj["maxAmount"])
        formattedObj["maxAmount"] = wei(obj["maxAmount"]);
    if (obj["currencyKey"])
        formattedObj["currencyKey"] = obj["currencyKey"];
    if (obj["totalFees"])
        formattedObj["totalFees"] = wei(obj["totalFees"]);
    if (obj["totalFeesInUSD"])
        formattedObj["totalFeesInUSD"] = wei(obj["totalFeesInUSD"]);
    return formattedObj as Pick<WrapperResult, K>;
};
export const getWrappers = async function <K extends keyof WrapperResult>(url: string, options: MultiQueryOptions<WrapperFilter, WrapperResult>, args: WrapperArgs<K>): Promise<Pick<WrapperResult, K>[]> {
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof WrapperFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type WrapperBurnFilter = {
    ...
    wrapperAddress_contains_nocase?: string | null;
    wrapperAddress_not_contains?: string | null;
    wrapperAddress_not_contains_nocase?: string | null;
    wrapperAddress_starts_with?: string | null;
    wrapperAddress_starts_with_nocase?: string | null;
    wrapperAddress_not_starts_with?: string | null;
    wrapperAddress_not_starts_with_nocase?: string | null;
...
export const getWrapperBurnById = async function <K extends keyof WrapperBurnResult>(url: string, options: SingleQueryOptions, args: WrapperBurnArgs<K>): Promise<Pick<WrapperBurnResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["account"])
        formattedObj["account"] = obj["account"];
    if (obj["principal"])
        formattedObj["principal"] = wei(obj["principal"]);
    if (obj["fee"])
        formattedObj["fee"] = wei(obj["fee"]);
    if (obj["amountOut"])
        formattedObj["amountOut"] = wei(obj["amountOut"]);
    if (obj["timestamp"])
        formattedObj["timestamp"] = wei(obj["timestamp"], 0);
...
export const getWrapperBurns = async function <K extends keyof WrapperBurnResult>(url: string, options: MultiQueryOptions<WrapperBurnFilter, WrapperBurnResult>, args: WrapperBurnArgs<K>): Promise<Pick<WrapperBurnResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<WrapperBurnFilter, WrapperBurnResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof WrapperBurnFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getWrapperMintById = async function <K extends keyof WrapperMintResult>(url: string, options: SingleQueryOptions, args: WrapperMintArgs<K>): Promise<Pick<WrapperMintResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["fee"])
        formattedObj["fee"] = wei(obj["fee"]);
    if (obj["amountIn"])
        formattedObj["amountIn"] = wei(obj["amountIn"]);
    if (obj["timestamp"])
        formattedObj["timestamp"] = wei(obj["timestamp"], 0);
    if (obj["wrapperAddress"])
        formattedObj["wrapperAddress"] = obj["wrapperAddress"];
...
export const getWrapperMints = async function <K extends keyof WrapperMintResult>(url: string, options: MultiQueryOptions<WrapperMintFilter, WrapperMintResult>, args: WrapperMintArgs<K>): Promise<Pick<WrapperMintResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<WrapperMintFilter, WrapperMintResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof WrapperMintFilter;
        paginatedOptions.where = { ...options.where };
    }
